...
int pipeline_native_float(struct halide_buffer_t *_input_buffer, float _r_sigma, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
...
int pipeline_native_float_old_buffer_t(struct buffer_t *_input, float _r_sigma, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
