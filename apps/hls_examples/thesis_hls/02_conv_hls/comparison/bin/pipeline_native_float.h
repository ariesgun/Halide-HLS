#ifndef HALIDE_____bin___pipeline_native_float_h
#define HALIDE_____bin___pipeline_native_float_h
#include <stdint.h>
...
int pipeline_native_float(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_weight_buffer, float _bias, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int pipeline_native_float_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *pipeline_native_float_metadata() HALIDE_FUNCTION_ATTRS;

int pipeline_native_float_old_buffer_t(struct buffer_t *_input, struct buffer_t *_weight, float _bias, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
...
struct halide_type_t {
     ...
     * instances. */
    HALIDE_ALWAYS_INLINE halide_type_t() : code((halide_type_code_t)0), bits(0), int_bits(0), lanes(0) {}
