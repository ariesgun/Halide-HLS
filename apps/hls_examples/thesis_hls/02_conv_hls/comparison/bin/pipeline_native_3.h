#ifndef HALIDE_____bin___pipeline_native_3_h
#define HALIDE_____bin___pipeline_native_3_h
#include <stdint.h>
...
int pipeline_native_3(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_weight_buffer, uint8_t _bias, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int pipeline_native_3_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *pipeline_native_3_metadata() HALIDE_FUNCTION_ATTRS;

int pipeline_native_3_old_buffer_t(struct buffer_t *_input, struct buffer_t *_weight, uint8_t _bias, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
