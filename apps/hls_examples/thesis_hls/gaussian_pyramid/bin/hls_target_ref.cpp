...
#pragma HLS RESOURCE variable=_floating_stencil_stream core=FIFO_SRL
 ...
 linebuffer<1542, 2566, 1, 1, 2, 2>(_floating_stencil_update_stream, _floating_stencil_stream);
 (void)0;
...
#pragma HLS RESOURCE variable=_gPyramid_0__stencil_update_stream core=FIFO_SRL
 ...
 for (int _gPyramid_0__y___scan_dim_1 = 0; _gPyramid_0__y___scan_dim_1 < 0 + 1283; _gPyramid_0__y___scan_dim_1++)
 {
  for (int _gPyramid_0__x___scan_dim_0 = 0; _gPyramid_0__x___scan_dim_0 < 0 + 771; _gPyramid_0__x___scan_dim_0++)
  {
...
#pragma HLS RESOURCE variable=_gPyramid_0__stencil_stream core=FIFO_SRL
 ...
 linebuffer<1542, 2566, 1>(_gPyramid_0__stencil_update_stream, _gPyramid_0__stencil_stream);
 (void)0;
...
#pragma HLS RESOURCE variable=_downx_stencil_update_stream core=FIFO_SRL
 ...
 {
  for (int _downx_x___scan_dim_0 = 0; _downx_x___scan_dim_0 < 0 + 770; _downx_x___scan_dim_0++)
  {
#pragma HLS PIPELINE II=1
...
#pragma HLS RESOURCE variable=_downx_stencil_stream core=FIFO_SRL
 ...
 linebuffer<770, 2566, 1>(_downx_stencil_update_stream, _downx_stencil_stream);
 (void)0;
...
#pragma HLS RESOURCE variable=_gPyramid_1__stencil_stream core=FIFO_SRL
 ...
 for (int _gPyramid_1__y___scan_dim_1 = 0; _gPyramid_1__y___scan_dim_1 < 0 + 1282; _gPyramid_1__y___scan_dim_1++)
 {
  for (int _gPyramid_1__x___scan_dim_0 = 0; _gPyramid_1__x___scan_dim_0 < 0 + 770; _gPyramid_1__x___scan_dim_0++)
  {
#pragma HLS PIPELINE II=1
