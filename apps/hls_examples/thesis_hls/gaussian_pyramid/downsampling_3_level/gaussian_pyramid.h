#ifndef HALIDE_____bin___gaussian_pyramid_h
#define HALIDE_____bin___gaussian_pyramid_h
#include <stdint.h>
...
int gaussian_pyramid(struct halide_buffer_t *_input_buffer, int32_t _levels, float _alpha, float _beta, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int gaussian_pyramid_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *gaussian_pyramid_metadata() HALIDE_FUNCTION_ATTRS;

int gaussian_pyramid_old_buffer_t(struct buffer_t *_input, int32_t _levels, float _alpha, float _beta, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
