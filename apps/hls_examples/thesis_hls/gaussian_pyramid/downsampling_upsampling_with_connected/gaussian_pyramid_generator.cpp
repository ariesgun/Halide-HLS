...
public:
    ...
    GeneratorParam<int>   pyramid_levels{"pyramid_levels", 2, 1, maxJ};
    ...
    Func build() {
        ...
        outGPyramid[0](x, y, c) = upsample(outGPyramid[1])(x, y, c) + floating(x, y, c);
        ...
        */
        ...
        if (get_target().has_hls_feature()) {
            ...
            gPyramid[0].linebuffer().compute_at(outGPyramid[0], x_grid);
            gPyramid[1].linebuffer().compute_at(outGPyramid[1], x);
            outGPyramid[1].linebuffer().compute_at(outGPyramid[0], x);
            //gPyramid[1].linebuffer().compute_at(gPyramid[2], x);
            //gPyramid[2].linebuffer().compute_at(gPyramid[3], xi);
            //gPyramid[2].linebuffer().compute_at(gPyramid[3], xi);
            //gPyramid[1].linebuffer().compute_at(outGPyramid[1], xi);
            //gPyramid[3].compute_root();
            ...
            //outGPyramid[0].unroll(x).unroll(y);
            outGPyramid[1].unroll(x).unroll(y);
            //gPyramid[2].unroll(x).unroll(y);
            //gPyramid[1].tile(x, y, xo, yo, xi, yi, 768, 1280);
            //gPyramid[3].tile(x, y, xo, yo, xi, yi, 192, 320);
            //gPyramid[3].tile(x, y, xo, yo, xi, yi, 192, 320);

            outGPyramid[0].tile(x, y, xo, yo, xi, yi, 1536, 2560);
            ...
            //gPyramid[3].accelerate({floating}, xi, xo);
