#ifndef LINEBUFFER_FIXED_H
#define LINEBUFFER_FIXED_H
...
template <size_t IMG_EXTENT_0, size_t EXTENT_1, size_t EXTENT_2, size_t EXTENT_3,
	  size_t IN_EXTENT_0,  size_t OUT_EXTENT_0, size_t T_W, size_t I_W, typename T>
class LinebufferFixed1D {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
    ...
    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> buffer[BUFFER_EXTENT];  // shift register
#pragma HLS ARRAY_PARTITION variable=buffer complete dim=1

    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> in_stencil;
    PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> out_stencil;
...
template <size_t IMG_EXTENT_0,
          size_t EXTENT_0, size_t EXTENT_1, size_t EXTENT_2, size_t EXTENT_3, size_t T_W, size_t I_W, typename T>
class LinebufferFixed1D<IMG_EXTENT_0,  EXTENT_1,  EXTENT_2,  EXTENT_3,
                 EXTENT_0, EXTENT_0, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                   stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
...
template <size_t IMG_EXTENT_0, size_t EXTENT_1, size_t EXTENT_2, size_t EXTENT_3,
	  size_t IN_EXTENT_0, size_t T_W, size_t I_W, typename T>
class LinebufferFixed1D<IMG_EXTENT_0, EXTENT_1,  EXTENT_2,  EXTENT_3,
                 IN_EXTENT_0,  IMG_EXTENT_0, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, IMG_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
    ...
    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> buffer[BUFFER_EXTENT_0];
...
#pragma HLS LOOP_FLATTEN off
#pragma HLS PIPELINE II=1
        PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> in = in_stream.read();
        // TODO make it a shift register
        buffer[idx_0] = in;

        if (idx_0 == BUFFER_EXTENT_0 - 1) {
            PackedStencilFixed<T, T_W, I_W, IMG_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> out;
...
template <size_t EXTENT_0, size_t EXTENT_1, size_t EXTENT_2, size_t EXTENT_3, size_t T_W, size_t I_W, typename T>
class LinebufferFixed1D<EXTENT_0,  EXTENT_1,  EXTENT_2,  EXTENT_3,
                 EXTENT_0, EXTENT_0, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
...
template <size_t IMG_EXTENT_0, size_t EXTENT_1, size_t EXTENT_2, size_t EXTENT_3,
	  size_t IN_EXTENT_0,  size_t OUT_EXTENT_0, size_t T_W, size_t I_W, typename T>
void linebufferFixed_1D(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
		   stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
    LinebufferFixed1D<IMG_EXTENT_0,  EXTENT_1,  EXTENT_2,  EXTENT_3,
                 IN_EXTENT_0,  OUT_EXTENT_0, T_W, I_W, T>::call(in_stream, out_stream);
}

template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1, size_t EXTENT_2, size_t EXTENT_3,
	  size_t IN_EXTENT_0, size_t IN_EXTENT_1,
	  size_t OUT_EXTENT_0, size_t OUT_EXTENT_1, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, OUT_EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
...
#pragma HLS DATAFLOW
    ...
    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> buffer[BUFFER_EXTENT_1][IDX_EXTENT_0];
#pragma HLS ARRAY_PARTITION variable=buffer complete dim=1

    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, OUT_EXTENT_1, EXTENT_2, EXTENT_3> slice;
    stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, OUT_EXTENT_1, EXTENT_2, EXTENT_3> > slice_stream;
...
#pragma HLS PIPELINE II=1
            ...
            PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> in_stencil = in_stream.read();
            if (row >= BUFFER_EXTENT_1) {
                ...
                for (size_t st_idx_0 = 0; st_idx_0 < IN_EXTENT_0; st_idx_0++) {
                    ...
                    //printf("Value in uffer %f\n", (float) in_stencil(st_idx_0, st_idx_1, st_idx_2, st_idx_3));
                }
 ...
 LB2D_Fixed_shift:for (size_t n1 = 0; n1 < NUM_OF_OUTPUT_1; n1++) {
        linebufferFixed_1D<IMG_EXTENT_0>(slice_stream, out_stream);
    }
}
};
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1,
          ...
          size_t EXTENT_1, size_t EXTENT_2, size_t EXTENT_3, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D<IMG_EXTENT_0,  IMG_EXTENT_1,  EXTENT_2,  EXTENT_3,
                   IN_EXTENT_0,  EXTENT_1,  OUT_EXTENT_0,  EXTENT_1, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
    for (size_t idx_1 = 0; idx_1 < IMG_EXTENT_1; idx_1 += EXTENT_1) {
        linebufferFixed_1D<IMG_EXTENT_0>(in_stream, out_stream);
    }
}
};
...
template <size_t EXTENT_0, size_t IMG_EXTENT_1, size_t EXTENT_2, size_t EXTENT_3,
	  size_t IN_EXTENT_1, size_t OUT_EXTENT_1, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D<EXTENT_0,  IMG_EXTENT_1,  EXTENT_2,  EXTENT_3,
                   EXTENT_0,  IN_EXTENT_1,  EXTENT_0,  OUT_EXTENT_1, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, OUT_EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE off
#pragma HLS DATAFLOW
    ...
    PackedStencilFixed<T, T_W, I_W, EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> buffer[BUFFER_EXTENT];  // shift register
#pragma HLS ARRAY_PARTITION variable=buffer complete dim=1

    PackedStencilFixed<T, T_W, I_W, EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> in_stencil;
    PackedStencilFixed<T, T_W, I_W, EXTENT_0, OUT_EXTENT_1, EXTENT_2, EXTENT_3> out_stencil;
...
template <size_t EXTENT_0, size_t IMG_EXTENT_1, size_t EXTENT_2, size_t EXTENT_3,
	  size_t EXTENT_1, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D<EXTENT_0,  IMG_EXTENT_1,  EXTENT_2,  EXTENT_3,
                   EXTENT_0,  EXTENT_1,  EXTENT_0,  EXTENT_1, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
...
template <size_t IMG_EXTENT_0, size_t EXTENT_1,
          size_t IN_EXTENT_0, size_t OUT_EXTENT_0,
          size_t EXTENT_2, size_t EXTENT_3, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D<IMG_EXTENT_0,  EXTENT_1,  EXTENT_2,  EXTENT_3,
                   IN_EXTENT_0,  EXTENT_1,  OUT_EXTENT_0,  EXTENT_1, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
...
template <size_t EXTENT_0, size_t EXTENT_2, size_t EXTENT_3,
	  size_t EXTENT_1, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D<EXTENT_0,  EXTENT_1,  EXTENT_2,  EXTENT_3,
                   EXTENT_0,  EXTENT_1,  EXTENT_0,  EXTENT_1, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1,
          ...
          size_t EXTENT_2, size_t EXTENT_3, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D<IMG_EXTENT_0,  IMG_EXTENT_1,  EXTENT_2,  EXTENT_3,
                   IN_EXTENT_0,  IN_EXTENT_1,  IMG_EXTENT_0,  IMG_EXTENT_1, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, IMG_EXTENT_0, IMG_EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
    ...
    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> buffer[BUFFER_EXTENT_1][BUFFER_EXTENT_0];
#pragma HLS ARRAY_PARTITION variable=buffer complete dim=0
...
#pragma HLS DEPENDENCE array inter false
            //#pragma HLS LOOP_FLATTEN off
#pragma HLS PIPELINE II=1
            PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> in = in_stream.read();
            // TODO make it a shift register
            buffer[idx_1][idx_0] = in;

            if (idx_1 == BUFFER_EXTENT_1 - 1
                && idx_0 == BUFFER_EXTENT_0 - 1) {
                PackedStencilFixed<T, T_W, I_W, IMG_EXTENT_0, IMG_EXTENT_1, EXTENT_2, EXTENT_3> out;
                // convert the array of stencils to a longer packed stencil
...
template <size_t IMG_EXTENT_0, size_t EXTENT_1,
          size_t IN_EXTENT_0, size_t EXTENT_2, size_t EXTENT_3, size_t T_W, size_t I_W, typename T>
class LinebufferFixed2D<IMG_EXTENT_0,  EXTENT_1,  EXTENT_2,  EXTENT_3,
                   IN_EXTENT_0,  EXTENT_1, IMG_EXTENT_0,  EXTENT_1, T_W, I_W, T> {
public:
static void call(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                 stream<PackedStencilFixed<T, T_W, I_W, IMG_EXTENT_0, EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1, size_t EXTENT_2, size_t EXTENT_3,
	  size_t IN_EXTENT_0, size_t IN_EXTENT_1,
	  size_t OUT_EXTENT_0, size_t OUT_EXTENT_1, size_t T_W, size_t I_W, typename T>
void linebufferFixed_2D(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                        stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, OUT_EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
    LinebufferFixed2D<IMG_EXTENT_0,  IMG_EXTENT_1,  EXTENT_2,  EXTENT_3,
                 IN_EXTENT_0,  IN_EXTENT_1,  OUT_EXTENT_0,  OUT_EXTENT_1, T_W, I_W, T>::call(in_stream, out_stream);
}
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1, size_t IMG_EXTENT_2, size_t EXTENT_3,
	  ...
	  size_t OUT_EXTENT_0, size_t OUT_EXTENT_1,  size_t OUT_EXTENT_2, size_t T_W, size_t I_W, typename T>
void linebufferFixed_3D(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, EXTENT_3> > &in_stream,
                   stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, OUT_EXTENT_1, OUT_EXTENT_2, EXTENT_3> > &out_stream) {
...
#pragma HLS DATAFLOW
    ...
    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, EXTENT_3> buffer[BUFFER_EXTENT_2][IDX_EXTENT_1][IDX_EXTENT_0];
#pragma HLS ARRAY_PARTITION variable=buffer complete dim=1

    PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, OUT_EXTENT_2, EXTENT_3> slice;
    stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, OUT_EXTENT_2, EXTENT_3> > slice_stream;
#pragma HLS STREAM variable=slice_stream depth=1
#pragma HLS RESOURCE variable=slice_stream core=FIFO_SRL

    size_t write_idx_2 = 0; // the line index of coming stencil in the linebuffer
 LB3DFixed_buf:for (size_t idx_2 = 0; idx_2 < IDX_EXTENT_2; idx_2++) {
#pragma HLS LOOP_FLATTEN off
...
#pragma HLS PIPELINE II=1
                ...
                PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, EXTENT_3> in_stencil = in_stream.read();
 ...
 LB3DFixed_shift:for (size_t n2 = 0; n2 < NUM_OF_OUTPUT_2; n2++) {
	linebufferFixed_2D<IMG_EXTENT_0, IMG_EXTENT_1>(slice_stream, out_stream);
    }
}
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1, size_t IMG_EXTENT_2,
          ...
          size_t EXTENT_2, size_t EXTENT_3, 
          size_t T_W, size_t I_W, typename T>
void linebufferFixed_3D(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, EXTENT_2, EXTENT_3> > &in_stream,
                   stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, OUT_EXTENT_1, EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
 LB_3D_fixed_pass:for (size_t idx_2 = 0; idx_2 < IMG_EXTENT_2; idx_2 += EXTENT_2) {
	linebufferFixed_2D<IMG_EXTENT_0, IMG_EXTENT_1>(in_stream, out_stream);
    }
}
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1, size_t IMG_EXTENT_2, size_t IMG_EXTENT_3,
          ...
          size_t EXTENT_3, size_t T_W, size_t I_W, typename T>
void linebufferFixed_4D(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, EXTENT_3> > &in_stream,
                   stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, OUT_EXTENT_1, OUT_EXTENT_2, EXTENT_3> > &out_stream) {
#pragma HLS INLINE
 LB_4D_fixed_pass:for (size_t idx_3 = 0; idx_3 < IMG_EXTENT_3; idx_3 += EXTENT_3) {
	linebufferFixed_3D<IMG_EXTENT_0, IMG_EXTENT_1, IMG_EXTENT_2>(in_stream, out_stream);
    }
}
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1=1, size_t IMG_EXTENT_2=1, size_t IMG_EXTENT_3=1,
	  ...
	  size_t T_W, size_t I_W, typename T>
void linebufferFixed(stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, IN_EXTENT_3> > &in_stream,
		stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, OUT_EXTENT_1, OUT_EXTENT_2, OUT_EXTENT_3> > &out_stream) {
    //static_assert(OUT_EXTENT_3 == IN_EXTENT_3, "dont not support 4D line buffer yet.");
#pragma HLS INLINE off
#pragma HLS DATAFLOW
    linebufferFixed_4D<IMG_EXTENT_0, IMG_EXTENT_1, IMG_EXTENT_2, IMG_EXTENT_3>(in_stream, out_stream);
}
...
template <size_t IMG_EXTENT_0, size_t IMG_EXTENT_1=1, size_t IMG_EXTENT_2=1, size_t IMG_EXTENT_3=1,
	  ...
	  size_t OUT_EXTENT_0, size_t OUT_EXTENT_1, size_t OUT_EXTENT_2, size_t OUT_EXTENT_3,
	  size_t T_W, size_t I_W, typename T>
void linebufferFixed(stream<AxiPackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, IN_EXTENT_3> > &in_axi_stream,
		stream<PackedStencilFixed<T, T_W, I_W, OUT_EXTENT_0, OUT_EXTENT_1, OUT_EXTENT_2, OUT_EXTENT_3> > &out_stream) {
...
#pragma HLS INLINE off
#pragma HLS DATAFLOW
    stream<PackedStencilFixed<T, T_W, I_W, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, IN_EXTENT_3> > in_stream;
...
#pragma HLS PIPELINE II=1
    ...
    linebufferFixed<IMG_EXTENT_0, IMG_EXTENT_1, IMG_EXTENT_2, IMG_EXTENT_3>(in_stream, out_stream);
}
