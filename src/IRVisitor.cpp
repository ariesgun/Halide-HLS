...
void IRVisitor::visit(const FixedPointImm *) {
}

void IRVisitor::visit(const DivImm *) {
}
...
void IRGraphVisitor::visit(const FixedPointImm *) {
}

void IRGraphVisitor::visit(const DivImm *) {
}
